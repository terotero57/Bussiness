...
genre=st.sidebar.radio(
    ...
    ('All','Low gain', 'Over Drive', 'Distortion','High Gain Metal','Delay','Reverb','Phaser','Flanger','Chorus','Tuner')
    )
if genre is not 'All' :
...
Maker=st.sidebar.radio(
    ...
    ('All','Boss', 'TC Electronic', 'MXR','Korg','Effect Bakery','Arion','Ibanez','Zoom')
    )
if Maker is not 'All' :
